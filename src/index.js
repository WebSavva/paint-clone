...
app.mobileBtn.addEventListener('click', () => app.toolbar.classList.toggle('visible'))
...
function displayBrushSize() {
    app.brushSizeElement.textContent = (app.brushSize / 10 > 1) ? app.brushSize : `0${app.brushSize}`;
}
...
function startDrawing(event) {
    ...
    canvas.addEventListener('mouseup', removeCanvasListeners);
}
